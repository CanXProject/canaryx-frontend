  ...
  ['lt-pane-views'],
  {
        ...
        c = (function (e) {
          ...
          return (
            ...
            (t.prototype.hitTest = function (e) {
              ...
              if (s.distance <= h) return new l.HitTestResult(l.HitTestResult.MOVEPOINT)
        ...
        function e() {
          ;(this._data = null),
            (this._priceLabelRenderer = new l.TextRenderer(
              void 0,
              new f.HitTestResult(f.HitTestResult.MOVEPOINT, { areaName: 'Style', itemIndex: 1 }),
            )),
            (this._hittest = new f.HitTestResult(f.HitTestResult.MOVEPOINT, { areaName: 'Style' }))
        }
        return (
          ...
          (e.prototype.draw = function (e, t) {
            ...
            if (!(null === i || i.points.length < 2)) {
              ...
              v(e, n, a, l), e.fill(), Object(u.drawLine)(e, n, a, o, s), this._priceLabelRenderer.draw(e, t)
              var h = 1 * r
              ;(e.strokeStyle = i.circleBorderColor), (e.lineWidth = h), v(e, n, a, l + h / 2), e.stroke(), e.restore()
            }
          }),
          (e.prototype.hitTest = function (e) {
            ...
            return Object(d.distanceToSegment)(t.points[0], t.points[1], e).distance <= i
              ? this._hittest
            ...
            if (t && !t.isEmpty()) {
              ...
              if (!(i.length < 2)) {
                var r = this._source.properties().childs(),
                  s = this._model.isDark() ? o.a['color-cold-gray-900'] : o.a['color-white'],
                  l = this._source.points()[0].price,
                  h = Object(n.ensureNotNull)(this._source.ownerSource()).firstValue(),
                  d = t.formatPrice(l, h)
                if (
                  ...
                  var c = i[0],
                    ...
                    y = void 0
                  y =
                    'left' === g ? _.clone() : 'right' === g ? f.clone() : new a.Point((c.x + u.x) / 2, (c.y + u.y) / 2)
                  ...
                  this._customLabelRenderer.setData(m), this._renderer.append(this._customLabelRenderer)
                }
              }
            }
          }),
      ...
      inherit(c, d),
        ...
        (c.prototype._updateImpl = function () {
          if (
            ...
            for (var u = this._source.properties(), p = 1; p <= this._source.levelsCount(); p++) {
              var _ = u['level' + p]
              if (_.visible.value()) {
                var f = _.coeff.value(),
                  v = _.color.value(),
        ...
        (c.prototype._updateRenderer = function () {
          if (!((w = this._points).length < 2)) {
            ...
            for (var _ = this._levels.length - 1; _ >= 0; _--) {
              ...
              var g = new l()
              if ((g.setData(v), g.setHitTest(new o(o.MOVEPOINT, null, f.index)), e.append(g), t.showCoeffs.value())) {
                var y = new a(this, _)
                e.append(y)
              }
            }
        ...
        (d.prototype._updateImpl = function () {
          ...
          if (
            ...
            var n = e.vertLabelsAlign.value(),
              ...
              _ = e.fontsize.value()
            if ('right' === s) {
              this._labelRenderer.setData({ text: d, font: p, bold: c, italic: u, fontsize: _ })
              var f = this._labelRenderer.measure().width,
                v = this._model.timeScale().width()
              l.x + f + 3 >= v ? (l.x += f + 3) : ((l.x = v), (h = 3))
            } else 'center' === s && (l.x = (l.x + this._model.timeScale().width()) / 2)
            var g = {
              points: [l],
              text: d,
    ...
    '2hKl': function (e, t, i) {
      ...
      function n(e, t, i, n, a) {
        for (var o, s = i.subtract(e).length() + i.subtract(t).length(), l = Math.max(3 / s, 0.02), h = 0; ; h += l) {
          h > 1 && (h = 1)
      ...
      function a(e, t, i, n, a, o) {
        for (
          var s,
            l = i.subtract(e).length() + n.subtract(i).length() + t.subtract(n).length(),
            h = Math.max(3 / l, 0.02),
            d = 0;
          ;
          d += h
      ...
      function o(e, t, i, r, n) {
        ...
        var o = (function (e, t, i, r, n) {
          for (var a = [], o = s(e.y, t.y, i.y, 0).concat(s(e.y, t.y, i.y, n)), h = 0; h < o.length; h++) {
        ...
        for (var h = 3 / a, d = [], c = 0; c < o.length - 1; c += 2) {
          for (var u = h, p = o[c], _ = o[c + 1] + u, f = []; p <= _; ) {
            var v = e.scaled((1 - p) * (1 - p)),
              ...
              y = t.scaled(p * p),
              w = v.add(g).add(y)
            if (f.length > 0) f[f.length - 1].subtract(w).length() < 2 && ((_ += u), (u *= 2))
            f.push(w), (p += u)
          }
          f.length > 0 && d.push(f)
        }
      ...
      function s(e, t, i, r) {
        ...
        if (Math.abs(a) > 1e-8) {
          var l = o * o - 4 * a * s
          l >= 0 && (n.push((-o + Math.sqrt(l)) / (2 * a)), n.push((-o - Math.sqrt(l)) / (2 * a)))
        } else n.push(-s / o)
        return n
      }
      function l(e, t, i, r) {
          ...
          return (
            ...
            (t.prototype._visiblePolygon = function (e) {
              ...
              if (
                ...
                (Object(s.distanceToLine)(i, r, o).distance < 1e-6 && Object(s.distanceToLine)(i, r, l).distance < 1e-6)
              )
                return null
              ...
              return (
                (h = u(h, i, r, [l, o])),
                (h = u(h, l, o, [i, r])),
                Object(a.equalPoints)(o, i) || t.extendLeft || (h = u(h, o, i, [r, l])),
                h
              )
            }),
            t
        ...
        (f.prototype._updateImpl = function () {
          if (
            ...
            ;((C = {}).points = [w, m]),
              ...
              (C.extendright = !1),
              (C.leftend = c.Normal),
              (C.rightend = Math.abs(w.x - m.x) >= 15 * C.linewidth ? c.Arrow : c.Normal),
      ...
      var c = (function (e) {
        ...
        return (
          ...
          (t.prototype._updateImpl = function (t, i) {
            if ((e.prototype._updateImpl.call(this, t, i), (this._renderer = null), !(this._points.length < 2))) {
              var r = this._source.properties().childs(),
                n = [],
                o = []
              if (3 === this._source.points().length) {
                var l = this._source.pointToScreenPoint(this._source.points()[0])[1],
                  h = this._source.pointToScreenPoint(this._source.points()[1])[1],
                  d = this._source.pointToScreenPoint(this._source.points()[2])[1],
                  c = h.subtract(l),
                  u = d.subtract(c.scaled(0.25)),
                  p = d.add(c.scaled(0.25))
                r.extendLeft.value() && (n = this._extendSegmentLeft(d, l, u, i, t)),
                  r.extendRight.value() && (o = this._extendSegmentRight(d, h, p, i, t))
              }
              ...
              var v = {
                ...
                backColor: Object(a.generateColor)(r.backgroundColor.value(), r.transparency.value()),
                extendLeftSegments: n,
                extendRightSegments: o,
              }
              this._bezierQuadroRenderer.setData(v)
              var g = new s.CompositeRenderer()
              g.append(this._bezierQuadroRenderer), this.addAnchors(g), (this._renderer = g)
            }
          }),
    ...
    '5/lF': function (e, t, i) {
      ...
      var f = (function () {
        ...
        v = new ((function () {
          function e(e) {
            var t = this
            ;(this._icons = new Map()), (this._onAllIconsLoaded = new p.a()), (this._pendingLoading = e.length)
            var i = function () {
        ...
        w = (function () {
          function e(e, t, i) {
            ;(this._fontSize = 0),
              ...
              (e.lines = this._lines =
                null === e.text ? [] : Object(s.wordWrap)(e.text, this.fontStyle(), e.wordWrapWidth)),
          ...
          return (
              ...
              if (this._rect) {
                if (
                  ...
                  for (
                    ...
                    this._drawIcon(e, p, _, u, Boolean(this._data.isDark), t), (n += 1)
                  }
              } else
            ...
            (e.prototype._preRender = function () {
              if (!this._preRendered) {
                ...
                if (this._data.wordWrapWidth) {
                  ...
                  for (var p = 0; p < this._lines.length; p++) u.push(this._data.wordWrapWidth)
                } else {
                  d = 0
                ...
                if (((i += v.left), (a += v.top), !o.isIE && this._data.icons)) {
                  var w = void 0 !== this._data.textPadding ? this._data.textPadding : Math.round(s / 2)
                  ;(i += g + w), (y.w += g + w)
                }
                if ('bottom' === this._data.vertAlign || 'middle' === this._data.vertAlign) {
                  var m = 'middle' === this._data.vertAlign ? n - y.h / 2 : n - y.h - (y.y - n)
                  ;(a += m - y.y), (y.y = m)
                }
                if ('right' === this._data.horzAlign || 'center' === this._data.horzAlign) {
                  var x = 'center' === this._data.horzAlign ? t - y.w / 2 : t - y.w - (y.x - t)
                  ;(i += x - y.x),
                    (y.x = x),
                    !0 !== this._data.doNotAlignText &&
                      ('right' === this._data.horzAlign
            ...
            (e.prototype._drawIcon = function (e, t, i, r, n, s) {
              var l = '' + r + this._data.isDark + s.pixelRatio,
                h = y.get(l)
              if (!h) {
                ;((h = document.createElement('canvas')).width = g * s.pixelRatio),
                  (h.height = g * s.pixelRatio),
                  (h.style.width = g + 'px'),
                  (h.style.height = g + 'px')
                var d = Object(a.ensureNotNull)(h.getContext('2d'))
                d.setTransform(1, 0, 0, 1, 0, 0), o.isEdge || d.scale(s.pixelRatio, s.pixelRatio)
        ...
        p = (function (e) {
          function t(t, i) {
            ...
            return (
              ...
              (r._polylineRenderer = new u.PolygonRenderer(new c.HitTestResult(c.HitTestResult.MOVEPOINT))),
          ...
          return (
            ...
            (t.prototype._updateImpl = function () {
              if (
                ...
                if (
                  (this._mainTriangleRenderer.setData(_), i.append(this._mainTriangleRenderer), this._points.length > 3)
                ) {
                  var f = {
                  ...
                  this._triangleRendererPoints234.setData(f), i.append(this._triangleRendererPoints234)
                }
                var v = {
                  points: this._points,
                  color: t.color.value(),
                ...
                if ((this._polylineRenderer.setData(v), i.append(this._polylineRenderer), this._points.length >= 3)) {
                  var g = r(h.add(c).scaled(0.5), this._numericFormatter.format(this._abRetracement))
                ...
                if (this._points.length >= 4) {
                  this._bcRetracementTrend.setData(s(d, u)), i.append(this._bcRetracementTrend)
                  g = r(d.add(u).scaled(0.5), this._numericFormatter.format(this._bcRetracement))
                  this._acLabelRenderer.setData(g), i.append(this._acLabelRenderer)
                }
                if (this._points.length >= 5) {
                  var y = r(c.add(p).scaled(0.5), this._numericFormatter.format(this._cdRetracement))
                  ...
                  var w = r(h.add(p).scaled(0.5), this._numericFormatter.format(this._xdRetracement))
                ...
                var m = r(h, 'X')
                d.y > h.y ? ((m.vertAlign = 'bottom'), (m.offsetY = 5)) : ((m.vertAlign = 'top'), (m.offsetY = 5)),
                  this._textRendererXLabel.setData(m),
                  i.append(this._textRendererXLabel)
                var x = r(d, 'A')
                if (
                  (d.y < h.y ? ((x.vertAlign = 'bottom'), (x.offsetY = 5)) : ((x.vertAlign = 'top'), (x.offsetY = 5)),
                  this._textRendererALabel.setData(x),
                  i.append(this._textRendererALabel),
                  this._points.length > 2)
                ) {
                  g = r(c, 'B')
                  c.y < d.y ? ((g.vertAlign = 'bottom'), (g.offsetY = 5)) : ((g.vertAlign = 'top'), (g.offsetY = 5)),
                    this._textRendererBLabel.setData(g),
                    i.append(this._textRendererBLabel)
                }
                if (this._points.length > 3) {
                  g = r(u, 'C')
                  u.y < c.y ? ((g.vertAlign = 'bottom'), (g.offsetY = 5)) : ((g.vertAlign = 'top'), (g.offsetY = 5)),
                    this._textRendererCLabel.setData(g),
                    i.append(this._textRendererCLabel)
                }
                if (this._points.length > 4) {
                  g = r(p, 'D')
                  p.y < u.y ? ((g.vertAlign = 'bottom'), (g.offsetY = 5)) : ((g.vertAlign = 'top'), (g.offsetY = 5)),
            ...
            (t.prototype._updateBaseData = function () {
              if (this._source.points().length >= 3) {
                var e = this._source.points(),
                  ...
                  i = e[1],
                  r = e[2]
                this._abRetracement = Math.round(1e3 * Math.abs((r.price - i.price) / (i.price - t.price))) / 1e3
              }
              if (this._source.points().length >= 4) {
                var n = this._source.points(),
                  a = ((i = n[1]), (r = n[2]), n[3])
                this._bcRetracement = Math.round(1e3 * Math.abs((a.price - r.price) / (r.price - i.price))) / 1e3
              }
              if (this._source.points().length >= 5) {
                var o = this._source.points(),
                  s = ((t = o[0]), (i = o[1]), (r = o[2]), (a = o[3]), o[4])
                ;(this._cdRetracement = Math.round(1e3 * Math.abs((s.price - a.price) / (a.price - r.price))) / 1e3),
                  (this._xdRetracement = Math.round(1e3 * Math.abs((s.price - i.price) / (i.price - t.price))) / 1e3)
              }
            }),
            t
          )
    ...
    '6sSH': function (e, t, i) {
      ...
      inherit(p, u),
        ...
        (_.prototype.getCacheRects = function (e, t) {
          ...
          if (i) {
            var n = this._points[1],
              ...
              o = Math.min(n.x, a.x),
              s = Math.max(n.x, a.x)
            ;(n = new r(o, this._levels[t].y)), (a = new r(s, this._levels[t].y))
            var l,
            ...
            var u = {
              ...
              p = { left: l.x - u.width, top: l.y, width: i.width, height: u.height },
        ...
        (_.prototype._createCache = function (e) {
          return new p(this._source.properties().fibLevelsBasedOnLogScale, this._source.levelsCount(), e)
        }),
        (_.prototype._updateImpl = function () {
          if ((c.prototype._updateImpl.call(this), (this._renderer = null), 3 === this._source.points().length)) {
            ...
            if (m) (f = e.priceToCoordinate(g, t) - e.priceToCoordinate(y, t)), (v = e.priceToCoordinate(p.price, t))
            for (
          ...
          if (!(this._points.length < 2)) {
              ...
              for (T = 0; T < this._levels.length; T++)
                if (T > 0 && B) {
                  var z = this._levels[T - 1],
                    E = ((i = new r(D, this._levels[T].y)), (u = new r(k, z.y)), {})
                  ;(E.points = [i, u]),
            ...
            for (T = 0; T < this._levels.length; T++) {
              O = {
                points: [(i = new r(H, this._levels[T].y)), (u = new r(W, this._levels[T].y))],
                width: this._model.timeScale().width(),
                height: this._source.priceScale().height(),
    ...
    '8GeE': function (e, t, i) {
              ...
              if (null !== this._data) {
                ...
                ;(this._cache[a] = r),
                  this._data.selected &&
                    ...
                    e.fillRect(-this._cache[a] / 2, -this._data.size / 2, this._cache[a], this._data.size)),
                  (e.fillStyle = this._data.color),
      ...
      var g = (function (e) {
        ...
        return (
          ...
          (t.prototype._updateImpl = function () {
            if ((e.prototype._updateImpl.call(this), (this._renderer = null), !(this._points.length < 1))) {
              ...
              ;(g = Object(a.transformPoint)(w, g)), (y = Object(a.transformPoint)(w, y))
              var m = _.add(g)
              m.data = 0
              var x = _.subtract(g)
              x.data = 1
              ...
              t.append(this.createLineAnchor({ points: [m, x, b, R], pointsCursorType: P })), (this._renderer = t)
            }
          }),
          t
        )
      ...
      inherit(h, l),
        ...
        (h.prototype.hitTest = function (e) {
          ...
          for (var h = this._data.counterclockwise ? -1 : 1, d = r.length(), c = 0; c < 4; c++) {
            ...
            if (null !== (p = (p * i.length()) / 5) && Math.abs(p - d) < 5) return new a(a.MOVEPOINT)
          }
          return null
        }),
        (h.prototype._drawImpl = function (e) {
          if (null !== this._data) {
            ...
            var o = Math.PI / 100
            e.moveTo(0, 0)
            for (var s = this._data.counterclockwise ? -1 : 1, l = 0; l < 50 * (this._fibNumbers().length - 1); l++) {
              var h = s * l * o,
    ...
    '9FRF': function (e, t, i) {
      ...
      var r = i('aB9a').LineSourcePaneView,
        ...
        s = [o.Default, o.Default, o.Default, o.Default, o.VerticalResize, o.VerticalResize]
      function l(e, t) {
        r.call(this, e, t),
      ...
      inherit(l, r),
        (l.prototype._updateImpl = function () {
          if (
            ...
            var p = { points: [] }
            this._points.length > 1 && (p.points.push(this._points[0]), p.points.push(this._points[1])),
              this._points.length > 2 &&
                null !== this._p3 &&
                null !== this._p4 &&
            ...
            this._model.lineBeingCreated() !== this._source || x || (v.pop(), v.pop()),
              f.append(this.createLineAnchor({ points: v, pointsCursorType: s })),
              (this._renderer = f)
          }
        }),
      ...
      inherit(S, m),
        ...
        (S.prototype.drawBalloon = function (e, t, i, n, a, o) {
          ...
          if ((e.beginPath(), 'down' === a)) {
            var l = new r(t.x - s, t.y - this._arrowOffset - this._arrowHeight - n)
            return (
          ...
          var h = new r(t.x - s, t.y + this._arrowOffset + this._arrowHeight + n)
          return (
        ...
        (S.prototype.drawTargetLabel = function (e) {
          ...
          this._targetRectLeftOffset = Math.max(20, Math.min(this._targetWidth - 15, x))
            ...
            ;(e.fillStyle = B),
              'up' === this._data.direction
                ? (y(e, R.x - 1, R.y - j - 2, this._targetWidth + 2, j, 5),
                  ...
                  e.drawImage(A, R.x + E - A.width - 4, R.y - j - 2 + Math.abs(j - A.height) / 2))
                : (y(e, R.x - 1, R.y + this._targetHeight + 2, this._targetWidth + 2, j, 5),
                  e.fill(),
                  (e.fillStyle = N),
                  e.fillText(k, R.x + E + V, R.y + this._targetHeight + 5),
                  e.drawImage(A, R.x + E - A.width - 4, R.y + this._targetHeight + 10 - Math.abs(j - A.height) / 2)),
              e.restore()
          } else e.restore()
        }),
        ...
        (S.prototype._drawImpl = function (e) {
          if (!(null === this._data || this._data.points.length < 2)) {
            ...
            e.fillStyle = this._data.color
            var a = r.y < 0 ? 1 : -1
            if (Math.abs(r.x) < 1 || Math.abs(r.y) < 1) var o = Math.atan(r.x / r.y)
            else {
              var s,
                l,
                h = Math.abs(r.x),
        ...
        (S.prototype.targetLabelHitTest = function (e) {
          ...
          var i = 'up' === this._data.direction ? -1 : 1,
            ...
            h = Math.min(s, l),
            d = Math.max(s, l)
          return e.x >= a && e.x <= a + this._targetWidth && e.y >= h && e.y <= d ? new o(o.MOVEPOINT) : null
        }),
        ...
        (P.prototype._updateImpl = function () {
          if (
            ...
            this._targetLine1 = b(e.format(r) + ' (' + this._percentageFormatter.format(o) + ')')
            ...
            if (h && l) {
              ;(this._targetLine4 = new c().format(h)),
                d || (this._targetLine4 = this._targetLine4 + '  ' + new u(v ? '%h:%m:%s' : '%h:%m').format(h))
              var g = (h.valueOf() - l.valueOf()) / 1e3
              this._targetLine2 = $.t('in', { context: 'dates' }) + ' ' + R(new p().format(g))
            }
            ...
            y &&
              ...
              d || (this._sourceLine2 = this._sourceLine2 + ' ' + new u(v ? '%h:%m:%s' : '%h:%m').format(y))),
            ...
            if ((h = r.measureText(s).width) <= t) a.push(s)
              ...
              for (var l = s.split(/([-)\]},.!?:;])|(\s+)/); l.length; ) {
                ...
                if (d > 0) a.push(l.slice(0, 3 * d - 1).join('')), l.splice(0, 3 * d)
                  ...
                  u < 1 && (u = 1), a.push(c.substr(0, u)), (l[0] = c.substr(u)), (l[1] = '')
                }
        ...
        (p.prototype._drawImpl = function (e) {
          if (!(null === this._data || this._data.points.length < 2)) {
            ...
            var a = h.RoundRadius,
              ...
              s = n + 2 * o + 2 * a,
              u = r + 2 * o + 2 * a
            ;(this._textSizeCache.totalWidth = s), (this._textSizeCache.totalHeight = u)
            var p = i.x - s / 2,
              _ = i.y - u / 2,
              f = 0,
              v = n + 2 * o > 2 * a,
            ...
            t.x > p + s ? (f = 20) : t.x > p && (f = 10),
              ...
              10 === f
                ? v
                  ? (e.lineTo(i.x - a, 0), e.lineTo(t.x, t.y), e.lineTo(i.x + a, 0), e.lineTo(s - a, 0))
                  : (e.lineTo(t.x, t.y), e.lineTo(s - a, 0))
                : e.lineTo(s - a, 0),
              20 === f ? (e.lineTo(t.x, t.y), e.lineTo(s, a)) : e.arcTo(s, 0, s, a, a),
              21 === f
                ? g
                  ? (e.lineTo(s, i.y - a), e.lineTo(t.x, t.y), e.lineTo(s, i.y + a), e.lineTo(s, u - a))
                  : (e.lineTo(t.x, t.y), e.lineTo(s, u - a))
                : e.lineTo(s, u - a),
              22 === f ? (e.lineTo(t.x, t.y), e.lineTo(s - a, u)) : e.arcTo(s, u, s - a, u, a),
              12 === f
                ? v
                  ? (e.lineTo(i.x + a, u), e.lineTo(t.x, t.y), e.lineTo(i.x - a, u), e.lineTo(a, u))
                  : (e.lineTo(t.x, t.y), e.lineTo(a, u))
                : e.lineTo(a, u),
              2 === f ? (e.lineTo(t.x, t.y), e.lineTo(0, u - a)) : e.arcTo(0, u, 0, u - a, a),
              1 === f
                ? g
        ...
        (_.prototype._updateImpl = function () {
          if (
            ...
            if ((l.splice(l.length - 1, 1), r.append(this.createLineAnchor({ points: l })), t.wordWrapWidth)) {
              var d = new n(o.x + (t.wordWrapWidth >> 1) + h.RoundRadius + h.TextMargins, o.y)
          ...
          return (
            ...
            (t.prototype.hitTest = function (e) {
              if (null === this._data || (void 0 !== this._data.mouseTouchable && !this._data.mouseTouchable))
                return null
              for (
                var t = Math.max(Object(s.lastEventIsTouch)() ? 24 : 3, Math.ceil(this._data.linewidth / 2)), i = 1;
                i < this._points.length;
                i++
              ) {
                var r = this._points[i - 1],
                  o = this._points[i]
                if (Object(a.distanceToSegment)(r, o, e).distance <= t) return this._hittest
              }
              if (this._data.filled && this._data.fillBackground && this._points.length > 0) {
                ;(r = this._points[0]), (o = this._points[this._points.length - 1])
                if (Object(a.distanceToSegment)(r, o, e).distance <= t) return this._hittest
              }
            ...
            (t.prototype._drawImpl = function (e, t) {
              ...
              if (null !== this._data && 0 !== this._points.length) {
                e.beginPath()
                var n = null !== (i = this._data.linecap) && void 0 !== i ? i : 'butt'
                ;(e.lineCap = n),
                  (e.strokeStyle = this._data.color),
                  (e.lineWidth = this._data.linewidth),
                ...
                if (p > 1) {
                  if (('butt' !== n && (e.lineCap = 'butt'), this._data.leftend === h.LineEnd.Arrow)) {
                    var _ = this._correctArrowPoints(this._points[1], this._points[0], e.lineWidth, n)
                    Object(l.drawArrow)(_[0], _[1], e, e.lineWidth, t.pixelRatio)
                  }
                  if (this._data.rightend === h.LineEnd.Arrow) {
                    _ = this._correctArrowPoints(this._points[p - 2], this._points[p - 1], e.lineWidth, n)
                    Object(l.drawArrow)(_[0], _[1], e, e.lineWidth, t.pixelRatio)
                  }
                }
              }
      ...
      var r = i('mrSG'),
        ...
        c = (function (e) {
          ...
          return (
            ...
            (t.prototype._updateImpl = function () {
              if ((e.prototype._updateImpl.call(this), (this._renderer = null), 0 !== this._points.length)) {
                var t = this._source.properties().childs(),
                  i = {
                    x: this._points[0].x,
                ...
                if (t.showLabel.value() && this._source.model().paneForSource(this._source) === this._pane) {
                  var s = 0,
                    l = 5,
                    h = 'center',
                    c = 'middle',
                  ...
                  if ('horizontal' === t.textOrientation.value()) {
                    ...
                    switch (((s = -Math.PI / 2), (l = 0), t.horzLabelsAlign.value())) {
                      case 'left':
                        c = 'bottom'
                        break
                      case 'right':
                ...
                if (1 === this._points.length) {
                  ...
                  ;(f.data = 0), (f.square = !0), r.append(this.createLineAnchor({ points: [f], pointsCursorType: d }))
                }
                this._renderer = r
              }
            }),
    ...
    CR3a: function (e, t, i) {
      ...
      inherit(c, d),
        ...
        (u.prototype._getColor = function () {
          return s.generateColor(this._data.backcolor, this._data.transparency, !0)
        }),
        inherit(p, h),
        (p.prototype.getCacheRects = function (e, t) {
          ...
          var u = {
            ...
            p = { left: Math.round(i.x - u.width), top: Math.round(i.y), width: a.width, height: u.height },
        ...
        (p.prototype._updateImpl = function () {
          ...
          for (
            ...
            if ((S = t['level' + c]).visible.value()) {
              ...
              var R = new u()
              R.setData(b), e.append(R), (t.showCoeffs.value() || t.showPrices.value()) && s(g, y, c)
            }
          }
          var T = null
          for (c = d; c >= 1; c--) {
      ...
      var v = (function () {
          ...
          return (
            ...
            (e.prototype._createSource = function (e, t, i) {
              ...
              Object(u.drawScaled)(r, this._renderParams.pixelRatio, function () {
                var n = 0.6 * e
                ;(r.fillStyle = i),
                  r.beginPath(),
                  r.moveTo(e / 2, t),
        ...
        g = (function () {
          ...
          return (
            ...
            (e.prototype.draw = function (e, t) {
              var i
              null !== this._data &&
                ((null !== this._source && Object(p.areEqualPaneRenderParams)(this._source.renderParams(), t)) ||
            ...
            (e.prototype._drawTooltipOn = function (e, t) {
              ...
              v < 10 ? (v = o.y + 13) : (y = 'bottom'),
                f < 10 ? (f += Math.abs(f - 10)) : f + p + 10 > i.vpWidth && (f -= f + p + 10 - i.vpWidth),
              ...
              e.moveTo(m, x),
                g || 'top' !== y || (e.lineTo(w - b, x), e.lineTo(w, x - b), e.lineTo(w + b, x)),
                e.lineTo(m + p, x),
                e.lineTo(m + p, x + _),
                g || 'bottom' !== y || (e.lineTo(w + b, x + _), e.lineTo(w, x + _ + b), e.lineTo(w - b, x + _)),
                e.lineTo(m, x + _),
                e.closePath(),
                e.fill(),
                e.stroke(),
              ...
              Object(u.drawScaled)(e, t.pixelRatio, function () {
                for (var t = 0; t < a.length; t++) e.fillText(a[t].replace(/^\s+/, ''), T, S), (S += i.fontSize + s)
              }),
                e.restore()
            }),
            e
          ...
          (e.prototype._repaintSource = function (e, t, i) {
            ...
            ;(i.points[0] = new n.Point(0, 0)),
              ...
              Object(h.drawScaled)(this._ctx, this._params.pixelRatio, function () {
                ...
                var n = new o.TrendLineStatsRenderer(i, { widths: [] }).draw(a._ctx, a._params)
          ...
          return (
            ...
            (t.prototype._updateImpl = function () {
              ...
              if (!(this._points.length < 2)) {
                ...
                if ((this._polyLineRenderer.setData(T), x.append(this._polyLineRenderer), this._points.length >= 5)) {
                  var S = void 0,
                    P = void 0,
                    L = !1,
                    C = !1
                  t ? (S = t) : ((S = h), (L = !0)), i ? (P = i) : ((P = p), (C = !0))
                  var M = {
                    points: [S, P],
                    color: m.color.value(),
                    linewidth: m.linewidth.value(),
                  ...
                  var I = R(h, u, p)
                  this._triangleRendererPoints234.setData(I), x.append(this._triangleRendererPoints234)
                }
                if (t) {
                  I = R(t, l, h)
                  this._intersect1Renderer.setData(I), x.append(this._intersect1Renderer)
                }
                if (i) {
                  I = R(p, f, i)
                  this._intersect2Renderer.setData(I), x.append(this._intersect2Renderer)
                }
                if (this._points.length >= 2) {
                  var O = b(l, _.leftShoulder)
                  l.y < s.y ? ((O.vertAlign = 'bottom'), (O.offsetY = 5)) : ((O.vertAlign = 'top'), (O.offsetY = 5)),
                    this._leftShoulderLabelRenderer.setData(O),
                    x.append(this._leftShoulderLabelRenderer)
                }
                if (this._points.length >= 4) {
                  O = b(u, _.head)
                  u.y < h.y ? ((O.vertAlign = 'bottom'), (O.offsetY = 5)) : ((O.vertAlign = 'top'), (O.offsetY = 5)),
                    this._headLabelRenderer.setData(O),
                    x.append(this._headLabelRenderer)
                }
                if (this._points.length >= 6) {
                  O = b(f, _.rightShoulder)
                  f.y < p.y ? ((O.vertAlign = 'bottom'), (O.offsetY = 5)) : ((O.vertAlign = 'top'), (O.offsetY = 5)),
        ...
        (u.prototype._updateImpl = function () {
          if (
            ...
            var i = Math.abs(t.x - e.x),
              n = Math.abs(t.y - e.y)
            this._levels = []
            for (var l = this._source.properties(), u = this._source.levelsCount(), p = 1; p <= u; p++) {
              var _ = l['level' + p]
              if (_.visible.value()) {
                var f = _.coeff.value(),
                  v = _.color.value(),
    ...
    'GS+0': function (e, t, i) {
      ...
      var r = i('aO4+').Point,
        ...
        h = i('a7Ha').LineEnd
      function d(e, t) {
        n.call(this, e, t), (this._lines = []), (this._trendRenderer = new o()), (this._renderer = null)
      }
      inherit(d, n),
        (d.prototype._updateImpl = function () {
          if ((n.prototype._updateImpl.call(this), (this._renderer = null), !(this._source.points().length < 2))) {
            ...
            if (this._source.priceScale() && !this._source.priceScale().isEmpty() && !e.isEmpty()) {
              ...
              if (((this._lines = []), 0 !== o)) {
                ...
                if (o > 0)
                  for (var c = t.index; c <= d.lastBar(); c += o) this._lines.push({ x: e.indexToCoordinate(c) })
                else for (c = t.index; c >= d.firstBar(); c += o) this._lines.push({ x: e.indexToCoordinate(c) })
                if (!(this._points.length < 2)) {
                  var u = new l(),
        ...
        c = (function (e) {
          ...
          return (
            ...
            (t.prototype._addAnchors = function (e, t, i) {
              ...
              i.append(this.createLineAnchor({ points: [e, t, r, a, o, s, l, h], pointsCursorType: _ }))
            }),
            t
          )
        })(h.LineSourcePaneView)
    ...
    GzSs: function (e, t, i) {
      ...
      function d(e, t) {
        h.call(this), (this._data = null), (this._cache = e), (this._adapter = t)
      }
      function c(e, t) {
        r.call(this, e, t), (this._rendererCache = {}), (this._renderer = new d(this._rendererCache, e._adapter))
      }
      inherit(d, h),
        ...
        (d.prototype._drawQuantityText = function (e, t, i) {
          ...
          var r = t + this._quantityWidth(e) / 2,
            n = i + this._height() / 2
          e.fillText(s.startWithLTR(this._getQuantity() + ''), r, n), e.restore()
        }),
      ...
      inherit(_, n),
        ...
        (_.prototype._updateImpl = function () {
          ...
          if (t && !t.isEmpty() && !i.isEmpty()) {
            ...
            for (_ = u(e.color.value()), g = 0; g < this._points.length - O; g++, I = -I)
              if (!(g < L)) {
      ...
      var r = i('mrSG'),
        ...
        _ = (function (e) {
          function t() {
            ...
            return (
              (t._geometryCache = { innerHeight: NaN, textHorizontalPadding: NaN, innerWidth: NaN, paddingLeft: NaN }),
          ...
          return (
            ...
            (t.prototype.hitTest = function (e, t) {
              ...
              var i = this._data.points[0].x - (this._geometryCache.paddingLeft + 20),
                ...
                n = Object(l.box)(
                  new l.Point(i, r),
                  new l.Point(i + this._geometryCache.innerWidth, r + this._geometryCache.innerHeight),
                )
              return Object(h.pointInBox)(e, n)
                ? new p.HitTestResult(p.HitTestResult.MOVEPOINT, { areaName: 'Text' })
                : null
            }),
            (t.prototype._drawImpl = function (e, t) {
              if (null !== this._data && 0 !== this._data.points.length) {
                e.font = this._data.font
                var i = this._measureInfo(e, this._data.label, this._data.fontSize),
                  r = i.paddingLeft,
                  n = i.innerHeight,
                  a = i.innerWidth,
            ...
            (t.prototype._measureInfo = function (e, t, i) {
              if (this._geomertryCacheInvalidated) {
                ...
                ;(this._geometryCache = { paddingLeft: 15, innerWidth: s, innerHeight: l, textHorizontalPadding: h }),
          ...
          (t.prototype._updateImpl = function (t, i) {
            ...
            var r = this._source.properties().childs(),
              s = {
                ...
                backgroundColor: Object(a.generateColor)(r.backgroundColor.value(), r.transparency.value()),
                font: Object(n.makeFont)(r.fontsize.value(), o.CHART_FONT_FAMILY),
                fontSize: r.fontsize.value(),
                label: r.text.value(),
              }
              ...
              if (!(this._points.length < 2)) {
                ...
                if (
                  ...
                  this._points.length >= 3 &&
                    (this._trendLineRendererPoints12.setData(S(d, u)), R.append(this._trendLineRendererPoints12)),
                  4 === this._points.length &&
                    (this._trendLineRendererPoints23.setData(S(u, p)), R.append(this._trendLineRendererPoints23), t))
                ) {
                  var P = {
                    points: [Object(n.ensureDefined)(i), Object(n.ensureDefined)(r), t],
                    color: b.color.value(),
                    linewidth: b.linewidth.value(),
                  ...
                  this._intersectionRenderer.setData(P), R.append(this._intersectionRenderer)
                }
                var L = T(h, 'A')
                d.y > h.y ? ((L.vertAlign = 'bottom'), (L.offsetY = 5)) : ((L.vertAlign = 'top'), (L.offsetY = 5)),
                  this._aLabelRenderer.setData(L),
                  R.append(this._aLabelRenderer)
                var C = T(d, 'B')
                if (
                  (d.y < h.y ? ((C.vertAlign = 'bottom'), (C.offsetY = 5)) : ((C.vertAlign = 'top'), (C.offsetY = 5)),
                  this._bLabelRenderer.setData(C),
                  R.append(this._bLabelRenderer),
                  this._points.length > 2)
                ) {
                  var M = T(u, 'C')
                  u.y < d.y ? ((M.vertAlign = 'bottom'), (M.offsetY = 5)) : ((M.vertAlign = 'top'), (M.offsetY = 5)),
                    this._cLabelRenderer.setData(M),
                    R.append(this._cLabelRenderer)
                }
                if (this._points.length > 3) {
                  var I = T(p, 'D')
                  p.y < u.y ? ((I.vertAlign = 'bottom'), (I.offsetY = 5)) : ((I.vertAlign = 'top'), (I.offsetY = 5)),
    ...
    KFbh: function (e, t, i) {
      ...
      function y(e, t, i, r) {
        ...
        return (
          (void 0 !== n && n.width === t) ||
            ((n = (function (e, t, i, r) {
              var n = Object(u.createDisconnectedCanvas)(document, new u.Size(t, t), 1),
                a = 0 === r ? Math.min(e.width, e.height) : Math.max(e.width, e.height),
      ...
      function R(e) {
        return e.inverseAnchorPosition ? b(e) - e.poleTailHeight * e.direction : b(e) + e.poleTailHeight * e.direction
      }
          ...
          return (
            ...
            (e.prototype.addItem = function (e) {
              ...
              if (e.inverseAnchorPosition) {
                ...
                ;(r[0] = new n.Point(r[0].x, b(t))), (t.labelId = this._labels.length)
              } else {
                var o = new p.TextRenderer(i)
                this._labels.push(o), (t.labelId = this._labels.length), (t.labelHeight = o.measure().height)
                var s =
                  1 === e.direction
                    ? Math.min(t.poleStartY - t.labelHeight, t.anchorY)
                    : Math.max(t.poleStartY + t.labelHeight, t.anchorY)
                t.anchorY !== s && ((t.anchorY = s), (i.points = [new n.Point(e.x, s)]), o.setData(i))
              }
              ...
              for (
                var r = function (r) {
                    var o = a._items[r],
                      ...
                      d = s[2]
                    if (l || h || d) {
                      var c = { hideCrosshairLinesOnHover: !0, itemIndex: l || h ? o.itemIndex : o.labelIndex }
                      d ? (c.areaName = v.TabNames.text) : h && (c.areaName = v.TabNames.style)
                      var u = a._showTooltipHandler
                      if (void 0 !== u) {
                        var p = { targetBox: a._itemRect(o, t.cssHeight), item: o.srcItem },
                          f = function (e) {
                        ...
                        ;(c.tapHandler = function (e) {
                          e.preventDefault(), u(p, new n.Point(e.clientX - e.localX, e.clientY - e.localY), f)
                        }),
                          (c.clickHandler = function (e) {
                            u(p, new n.Point(e.clientX - e.localX, e.clientY - e.localY), f)
                          })
                        ...
                        void 0 !== g &&
                          ...
                          (c.executeDefaultAction = { pressedMouseMoveHandler: !0, touchMoveHandler: !0 }))
                      }
                      return { value: new _.HitTestResult(a._hitTestResult, c) }
                    }
                  },
                  a = this,
              ...
              if (null !== this._data) {
                ...
                for (var l = 0, h = this._items; l < h.length; l++) {
                  ...
                  e.moveTo(c, Math.round(m(d) * a)),
                    ...
                    0 !== d.poleTailHeight && (e.moveTo(c, Math.round(b(d) * a)), e.lineTo(c, Math.round(R(d) * a)))
                }
                e.stroke()
                for (var u = 0, p = this._items; u < p.length; u++) {
                  ...
                  ;(e.strokeStyle = d.circleBorderColor),
                    ...
                    d.circleRadius > 0 && T(e, d, n, this._data.shadowColor, this._data.outsideBorderColor, a),
            ...
            (e.prototype._doesPointBelongToItem = function (e, t) {
              var i = Object(c.lastEventIsTouch)() ? 20 : 3,
                r = e.x,
                a = Object(h.distanceToSegment)(new n.Point(r, m(e)), new n.Point(r, x(e)), t).distance < i,
                o =
                  !a &&
                  e.circleRadius > 0 &&
              ...
              return [a, o, !a && !o && null !== this._labels[e.labelId].hitTest(t)]
            }),
            e
          )
        })(),
      ...
      function M(e, t) {
        ...
        switch (e.style()) {
          ...
          case 12:
            ...
            break
          case 0:
            o = s.barStyle.thinBars.value() ? 3 : Math.max(3, 0.25 * h.barSpacing())
            break
          case 11:
            o = s.rangeStyle.thinBars.value() ? 3 : Math.max(3, 0.25 * h.barSpacing())
            break
          case 4:
          case 7:
            o = 3
        ...
        var u = Object(l.c)(t.position(), r.isInverted()),
          p = d - u * o
        return { index: i.index, price: i.price, poleStartY: p, visualDirection: u, positionPointDirection: u }
      }
      var I = (function () {
                  ...
                  for (
                    ...
                    if (!this._timeLine.isHidden(p.category())) {
                      ...
                      if (null !== f) {
                        ...
                        w >= -1e-10 && w <= e + 1e-10 && (w = Math.min(e - 2, Math.max(2, w)))
                        var m = f.visualDirection !== f.positionPointDirection,
                          x = f.visualDirection,
                          b = this._timeLine.isItemSelected(p),
                          R = this._timeLine.isItemHovered(p),
                          T = {
                            circleBackgroundColor: p.backgroundPlateColor(o) || h.circleBackgroundColor,
                            ...
                            labelFontItalic: (p.fontItalic && p.fontItalic()) || !1,
                            labelBorderRadius: 4,
                            labelPadding: 3,
                        ...
                        this._timeLine.isItemHovered(p) ? (a = T) : this._timeLineItemsRenderer.addItem(T)
                      }
                    }
                  }
      ...
      var B = (function (e) {
        function t(t, i) {
          ...
          return (
            ...
            (r._storiesEventsPaneView = new I(i, t, _.HitTestResult.MOVEPOINT, void 0, t.isPhantom())),
            r
          )
        }
        return (
          ...
          (t.prototype._updateImpl = function (t, i) {
            e.prototype._updateImpl.call(this), this._renderer.clear(), this._storiesEventsPaneView.update()
            var r = this._storiesEventsPaneView.renderer(t, i)
            if ((null !== r && this._renderer.append(r), !this._source.isPhantom())) {
              ...
              if (null !== a) {
                ...
                ;(s.data = o.data),
                  ...
                  this._renderer.append(
                    this.createLineAnchor({ points: [s], pointsCursorType: [D.PaneCursorType.VerticalResize] }),
                  )
              }
            }
          }),
    ...
    LMGK: function (e, t, i) {
      ...
      var r = i('mrSG'),
        ...
        v = (function (e) {
          function t(t) {
            var i = e.call(this) || this
            return (i._data = null), (i._cache = {}), (i._data = null), (i._adapter = t), i
          }
          return (
            Object(r.c)(t, e),
            (t.prototype.setData = function (e) {
            ...
            (t.prototype.hitTest = function (e, t) {
              ...
              if (this._adapter.getEditable() && e.x >= i.left && e.x < i.bodyRight) {
                var r = this._adapter.hasMoveCallback() ? c.HitTestResult.MOVEPOINT : c.HitTestResult.REGULAR
              ...
              return this._adapter.getEditable() && e.x >= i.bodyRight && e.x < i.quantityRight
                ? this._adapter.hasModifyCallback()
                  ? new c.HitTestResult(c.HitTestResult.CUSTOM, {
                      ...
                      tapHandler: this._adapter.callOnModify.bind(this._adapter),
                      tooltip: {
                        text: this._adapter.getModifyTooltip() || Object(u.appendEllipsis)(_),
            ...
            (t.prototype._height = function () {
              return Math.max(
                20,
                1 + Math.max(p.fontHeight(this._adapter.getBodyFont()), p.fontHeight(this._adapter.getQuantityFont())),
              )
            }),
            ...
            (t.prototype._drawLines = function (e, t, i, r, n) {
              e.save(),
                ...
                this._adapter.getExtendLeft() && Object(h.drawLine)(e, 0, r, t, r),
                e.restore()
            }),
            (t.prototype._drawMovePoints = function (e, t, i) {
              ...
              for (var r = t + 4, n = r + 2, a = Math.floor((this._height() - 10) / 2) + 1, o = 0; o < a; ++o) {
                var s = i + 5 + 2 * o
            ...
            (t.prototype._drawCancelButton = function (e, t, i, r) {
              ...
              e.fillRect(t + 0.5, i + 0.5, a - 1, o - 1),
                this._adapter.getBlocked() &&
                  ((e.fillStyle = 'rgba(140, 140, 140, 0.75)'), e.fillRect(t + 0.5, i + 0.5, a - 1, o - 1)),
                e.save(),
                r && e.clip && (e.beginPath(), e.rect(t + 0.5, i - 0.5, a + 1, o + 1), e.clip()),
              ...
              var d = (this._cancelButtonWidth() - 8) / 2,
                c = (this._height() - 8) / 2
              Object(h.drawPoly)(e, [new n.Point(t + d, i + c), new n.Point(s - d, l - c)], !0),
                Object(h.drawPoly)(e, [new n.Point(s - d, i + c), new n.Point(t + d, l - c)], !0)
            }),
            t
          )
          ...
          (t.prototype._updateImpl = function (t) {
            if (
              ...
              var i = this._points[0].y,
                r = t - 3.5 - 1,
                a = this._adapter.hasMoveCallback() ? c.HitTestResult.MOVEPOINT : c.HitTestResult.REGULAR,
                o = [new n.Point(r, i)]
              this._selectionData = {
                barSpacing: this._model.timeScale().barSpacing(),
                points: o,
        ...
        h = (function (e) {
          ...
          return (
            ...
            (t.prototype._createCache = function (e) {
              return new s.a(this._source.properties().fibLevelsBasedOnLogScale, this._source.levelsCount(), e)
            }),
        ...
        u = (function (e) {
          ...
          return (
              ...
              if (!(null === this._data || this._data.points.length < 2)) {
                ...
                if (
                  ...
                  var a = this._data.points,
                    ...
                    s = a[3]
                  if (
                    (this._data.skipLines || this._data.skipTopLine || this._extendAndDrawLineSegment(e, o, s, t),
            ...
            (t.prototype._extendAndHitTestLineSegment = function (e, t, i, r) {
              var n = this._extendAndClipLineSegment(t, i, r)
              if (null !== n && Object(o.distanceToSegment)(n[0], n[1], e).distance <= 3) return this._hittestResult
              return null
            }),
    ...
    Ni7V: function (e, t, i) {
      ...
      inherit(v, f),
        ...
        (v.prototype._drawImpl = function (e) {
          if (null !== this._data && null !== this._points && 0 !== this._points.length) {
            ...
            this._measureCache &&
              ...
              e.arcTo(n, a, 0, a, 3),
              e.lineTo(12, a),
              (e.fillStyle = u.generateColor(this._data.backgroundColor, this._data.transparency)),
              e.fill(),
              (e.strokeStyle = this._data.borderColor),
              (e.lineWidth = 2),
              e.stroke(),
              ...
              (e.fillStyle = u.generateColor(this._data.borderColor, this._data.transparency)),
              e.fill(),
        ...
        (g.prototype._updateImpl = function () {
          if ((s.prototype._updateImpl.call(this), (this._renderer = null), this._source.points().length > 0)) {
                ...
                e.save(),
                  ...
                  this._data.fillBackground &&
                    (this._data.wholePoints &&
                      (e.translate(a.x, a.y), e.scale(1, n / r), e.arc(0, 0, o / 2, 0, 2 * Math.PI, !0)),
                    (e.fillStyle = Object(s.generateColor)(this._data.backcolor, this._data.transparency, !0)),
                    e.fill())
              }
            }),
            t
        ...
        s = (function () {
          ...
          return (
            ...
            (e.prototype.draw = function (e, t) {
              ...
              ;(e.font = Object(o.makeFont)(this._data.fontSize, this._data.font, this._data.bold ? 'bold' : void 0)),
                (e.textBaseline = 'middle'),
                (e.textAlign = 'center'),
                (e.fillStyle = this._data.color),
      ...
      var _ = (function (e) {
        function t(t, i) {
          ...
          return (
            ...
            (r._ellipseRenderer = new p.EllipseRendererSimple(r._ellipseRendererData)),
            r
          )
        }
        return (
          ...
          (t.prototype.renderer = function (e, t) {
            ...
            return (
              this._textRendererData.points &&
                ...
                n.showLabel.value() &&
                (this._textRenderer.setData(Object(r.a)({}, this._textRendererData)), i.append(this._textRenderer)),
              this.addAnchors(i),
              i
            )
          }),
    ...
    R7Bt: function (e, t, i) {
      ...
      function p(e, t) {
        u.call(this, e, t), (this._rendererCache = {}), (this._trendLineRenderer = new o()), (this._renderer = null)
      }
      inherit(p, u),
        (p.prototype.getCacheRects = function (e, t) {
          if ((u.prototype.getCacheRects.call(this, e, i), !this._cacheState.preparedCells)) return null
          ...
          switch (c.horzLabelsAlign.value()) {
            case 'left':
              ...
              break
            case 'center':
              ;((d = o.add(s).scaled(0.5)).x += a.width / 2), (d.x = Math.round(d.x))
              break
            case 'right':
              c.extendLines.value()
                ? (d = new n(p - 4, this._levels[t].y))
                : (((d = new n(p + 4, this._levels[t].y)).x += a.width), (d.x = Math.round(d.x)))
          }
          var f = {
              left: a.left,
        ...
        (p.prototype._updateImpl = function () {
          if ((u.prototype._updateImpl.call(this), (this._renderer = null), !(this._source.points().length < 2))) {
            var e = this._source.priceScale()
            if (e && !e.isEmpty() && !this._model.timeScale().isEmpty()) {
              ...
              if (null != t) {
                var i = this._source.points()[0],
                  ...
                  p = !1
                ;(C = this._source.properties()).reverse && C.reverse.value() && (p = C.reverse.value()),
                  (this._levels = [])
                var _,
                  f,
                  v = p ? i.price : r.price,
                ...
                if (!(this._points.length < 2)) {
                    ...
                    for (R = 0; R < this._levels.length; R++)
                      if (R > 0 && D) {
                        var A = this._levels[R - 1],
                          j = ((i = new n(I, this._levels[R].y)), (r = new n(O, A.y)), {})
                        ;(j.points = [i, r]),
                  ...
                  for (R = 0; R < this._levels.length; R++) {
                    var V,
                      H = {
                        points: [(i = new n(z, this._levels[R].y)), (r = new n(E, this._levels[R].y))],
                        width: this._model.timeScale().width(),
                        height: this._source.priceScale().height(),
                    ...
                    if (
                      ((V = new o()).setData(H),
                      V.setHitTest(new l(l.MOVEPOINT, null, this._levels[R].index)),
                      M.append(V),
            ...
            (t.prototype._updateImpl = function () {
              ...
              if (this._source.points().length >= 4) {
                var r = this._source.points(),
                  ...
                  s = r[2],
                  d = r[3]
                t = Math.round(100 * Math.abs((d.price - s.price) / (s.price - o.price))) / 100
              }
              if (this._source.points().length >= 6) {
                var c = this._source.points(),
                  u = ((d = c[3]), c[4]),
                  p = c[5]
                i = Math.round(100 * Math.abs((p.price - u.price) / (u.price - d.price))) / 100
              }
              if (!(this._points.length < 2)) {
                ...
                if ((this._polyLineRenderer.setData(y), f.append(this._polyLineRenderer), !isNaN(t))) {
                  ;(m = new l.TrendLineRenderer()).setData(g(this._points[1], this._points[3])), f.append(m)
                  var w = v(this._points[1].add(this._points[3]).scaled(0.5), this._numericFormatter.format(t))
                  this._retrace1LabelRenderer.setData(w), f.append(this._retrace1LabelRenderer)
                }
                if (!isNaN(i)) {
                  var m
                  ;(m = new l.TrendLineRenderer()).setData(g(this._points[3], this._points[5])), f.append(m)
                  w = v(this._points[5].add(this._points[3]).scaled(0.5), this._numericFormatter.format(i))
                  this._retrace12LabelRenderer.setData(w), f.append(this._retrace12LabelRenderer)
                }
          ...
          if ((a.prototype._updateImpl.call(this), (this._renderer = null), 3 === this._source.points().length)) {
            ...
            for (var _ = 1; _ <= 11; _++) {
              ...
              if (f.visible.value()) {
                ...
                u.showCoeffs.value() && ((w.text = v), (w.y = this._source.priceScale().height())), this._levels.push(w)
              }
            }
          }
          if (!(this._points.length < 2)) {
            ...
            if ((u = this._source.properties()).trendline.visible.value()) {
              ...
              this._trendLineRendererPoints12.setData(x), m.append(this._trendLineRendererPoints12)
            }
            ...
            if (u.trendline.visible.value()) {
              ...
              this._trendLineRendererPoints23.setData(x), m.append(this._trendLineRendererPoints23)
            }
            ...
            for (_ = 0; _ < this._levels.length; _++) {
              if (void 0 !== this._levels[_].text) {
                ...
                switch (((M = 'left' === M ? 'right' : 'right' === M ? 'left' : 'center'), u.vertLabelsAlign.value())) {
                  case 'top':
        ...
        (g.prototype._updateImpl = function () {
          if (
            ...
            ;((k = {}).points = [d, _]),
              ...
              (k.extendright = !1),
              (k.leftend = p.Normal),
              (k.rightend = Math.abs(i.x - a.x) >= 25 * k.linewidth ? p.Arrow : p.Normal),
            ...
            ;(d = new r(g, i.y + Math.sign(a.y - i.y) * s)), (_ = new r(g, a.y + Math.sign(i.y - a.y) * s))
            ;((k = {}).points = [d, _]),
              (k.width = this._model.timeScale().width()),
              (k.height = this._source.priceScale().height()),
              (k.color = this._source.properties().linecolor.value()),
              ...
              (k.extendright = !1),
              (k.leftend = p.Normal),
              (k.rightend = Math.abs(d.y - _.y) >= 25 * k.linewidth ? p.Arrow : p.Normal),
            ...
            M &&
              ...
              ((this._pipFormatter = new u(M.pricescale, M.minmov, M.type, M.minmove2)), (this._lastSymbolInfo = M))
            var I,
              O =
        ...
        (_.prototype._updateImpl = function () {
          if (
            ...
            ;((M = {}).points = [m, x]),
              ...
              (M.extendright = !1),
              (M.leftend = u.Normal),
              (M.rightend = Math.abs(m.y - x.y) >= 15 * M.linewidth ? u.Arrow : u.Normal),
            ...
            var L,
              ...
              M = {}
            if (R > b) ((L = l.clone()).y -= 2 * t.fontsize.value()), (L.x = 0.5 * (s.x + l.x)), (M.points = [L])
            else ((L = l.clone()).x = 0.5 * (s.x + l.x)), (L.y += 0.7 * t.fontsize.value()), (M.points = [L])
            var I = { x: 0, y: 10 }
            ;(M.text = C),
        ...
        p = (function (e) {
          ...
          return (
            ...
            (t.prototype._updateImpl = function () {
              ...
              this._prepareLevels(t, p), this._prepareFanLines(t, p), this._prepareArcs(t, p), this._prepareLabels(t, p)
              var _ = [r, n]
            ...
            (t.prototype._initRenderers = function () {
              ...
              for (i = 0; i < r; i++) this._fanRenderers.push(new o.TrendLineRenderer())
              var n = e.arcsCount()
        ...
        (m.prototype._updateImpl = function () {
          ...
          if (((this._label = null), !(this._source.points().length < 2))) {
            ...
            if (this._source.properties().showPriceRange.value() && this._source.priceScale()) {
              ...
              s = this._source.ownerSource().formatter().format(x) + ' (' + new h().format(100 * b) + ') '
              ...
              R &&
                ...
                (s += this._pipFormatter ? ', ' + this._pipFormatter.format(x) : ''),
                m.push('priceRange')
            }
            ...
            if (this._secondPoint && this._points.length > 0) {
              ...
              this._angleLabelRenderer.setData(E), S.append(this._angleLabelRenderer)
            }
            0,
              this._secondPoint &&
          ...
          return (
            ...
            (t.prototype.hitTest = function (e, t) {
              ...
              if (4 === i.points.length) {
                ...
                if (Object(h.c)(d, a, _, e, r) || Object(h.a)(d, c, f, g, e, r) || Object(h.c)(c, s, y, e, r))
                  return new l.HitTestResult(l.HitTestResult.MOVEPOINT)
                var w = Object(p.c)(e, r, i.extendLeftPoints)
                return null === w && (w = Object(p.c)(e, r, i.extendRightPoints)), w
              }
              return null
            }),
            (t.prototype._drawImpl = function (e, t) {
              if (null !== this._data) {
                ...
                if (2 === this._data.points.length)
                  e.beginPath(),
                    ...
                    e.lineTo(r.x, r.y),
                    e.stroke(),
                    this._data.leftEnd === u.LineEnd.Arrow && Object(c.drawArrow)(r, i, e, e.lineWidth, t.pixelRatio),
                    this._data.rightEnd === u.LineEnd.Arrow && Object(c.drawArrow)(i, r, e, e.lineWidth, t.pixelRatio)
                else {
                  ...
                  this._data.fillBack &&
                    ...
                    e.stroke(),
                    this._data.leftEnd === u.LineEnd.Arrow && Object(c.drawArrow)(s, i, e, e.lineWidth, t.pixelRatio),
                    this._data.rightEnd === u.LineEnd.Arrow && Object(c.drawArrow)(f, r, e, e.lineWidth, t.pixelRatio)
                }
              }
            }),
            t
      ...
      var y = (function (e) {
        ...
        return (
          ...
          (t.prototype._updateImpl = function (t, i) {
            if ((e.prototype._updateImpl.call(this, t, i), (this._renderer = null), !(this._points.length < 2))) {
              ...
              if (4 === this._source.points().length) {
                var s = this._source.pointToScreenPoint(this._source.points()[0])[1],
                  l = this._source.pointToScreenPoint(this._source.points()[1])[1],
                  h = this._source.pointToScreenPoint(this._source.points()[2])[1],
                  d = this._source.pointToScreenPoint(this._source.points()[3])[1],
                  c = d.subtract(s),
                  u = h.subtract(c.scaled(0.25)),
                  p = l.subtract(h),
                  _ = d.add(p.scaled(0.25))
                r.extendLeft.value() && (a = this._extendSegmentLeft(h, s, u, i, t)),
                  r.extendRight.value() && (o = this._extendSegmentRight(d, l, _, i, t))
              }
              var v = this._points.slice(),
                g = this._source.controlPoints()
              null !== g &&
                (v.push(this._source.pointToScreenPoint(g[0])[0]), v.push(this._source.pointToScreenPoint(g[1])[0]))
              var y = {
                points: v,
                color: r.linecolor.value(),
                lineWidth: r.linewidth.value(),
                ...
                rightEnd: r.rightEnd.value(),
                fillBack: r.fillBackground.value(),
                backColor: Object(n.generateColor)(r.backgroundColor.value(), r.transparency.value()),
                extendLeftPoints: a,
                extendRightPoints: o,
              }
              this._bezierCubicRenderer.setData(y)
              var w = new f.CompositeRenderer()
              w.append(this._bezierCubicRenderer), this.addAnchors(w), (this._renderer = w)
            }
          }),
          (t.prototype._extendSegmentLeft = function (e, t, i, r, n) {
            return (
              Object(v.cacheIsValid)(this._extendedSegmentLeftCache, e, t, i, r, n) ||
                (this._extendedSegmentLeftCache = {
                  p1: e,
                  p2: t,
                  p3: i,
          ...
          (t.prototype._extendSegmentRight = function (e, t, i, r, n) {
            return (
              Object(v.cacheIsValid)(this._extendedSegmentRightCache, e, t, i, r, n) ||
                (this._extendedSegmentRightCache = {
                  p1: e,
                  p2: t,
                  p3: i,
          ...
          return (
            (e.prototype.draw = function (e, t) {
              if (this._data.visible) {
                for (var i = [], r = [], n = [], a = [], o = 0; o < this._data.points.length; ++o) {
            ...
            (e.prototype.hitTest = function (e) {
              for (var t = this._data.radius || u(), i = 0; i < this._data.points.length; ++i) {
                ...
                if (r.subtract(e).length() <= t + 2) {
                  ...
                  return new o.HitTestResult(this._data.hittestResult, { pointIndex: r.data, cursorType: n })
                }
              }
              return null
            }),
            ...
            (e.prototype._drawPoints = function (e, t, i, r, n, a) {
              ...
              for (var _ = (h % 2) / 2, f = 0; f < i.length; ++f) {
                ...
                if (
                  ...
                  if (
                    (n(e, new p(Math.round(v.x * t) + _, Math.round(v.y * t) + _, v.data, v.square), c / 2, l),
                    v.subtract(o).length() <= s + 2)
                  ) {
                    var g = Math.max(1, Math.floor(this._data.selectedStrokeWidth * t)),
                      y = Math.round(s * t * 2)
                    y % 2 != h % 2 && (y += 1),
                      a(e, new p(Math.round(v.x * t) + _, Math.round(v.y * t) + _, v.data, v.square), y / 2, g)
                  }
              }
            }),
            e
      ...
      var b = (function () {
        ...
        return (
          ...
          (e.prototype._lineAnchorColors = function (e) {
            var t = this,
              i = Object(m.ensureNotNull)(this._model.paneForSource(this._source)).height()
      ...
      inherit(h, l),
        ...
        (h.prototype._drawImpl = function (e) {
          null !== this._data &&
            ...
            e.stroke(),
            this._data.fillBackground &&
              ((e.fillStyle = s.generateColor(this._data.backcolor, this._data.transparency)), e.fill()))
        }),
        (h.prototype.hitTest = function (e) {
          ...
          i.y /= n
          var o = i.length()
          return Math.abs(o - this._data.width / 2) < 3 ? new a(a.MOVEPOINT) : null
        }),
        inherit(d, n),
        (d.prototype.renderer = function (e, t) {
          return this._invalidated && this._updateImpl(), this._renderer
        ...
        (d.prototype._updateImpl = function () {
          if ((n.prototype._updateImpl.call(this), (this._renderer = null), !(this._points.length < 2))) {
            ...
            if (0 !== l) {
              for (var v = Math.min(d.x, c.x), g = [], y = a; v > -u; y -= l) (v = f.indexToCoordinate(y)), g.push(v)
              v = Math.max(d.x, c.x)
              for (y = s; v < f.width(); y += l) (v = f.indexToCoordinate(y)), g.push(v)
          ...
          return (
            ...
            (t.prototype.hitTest = function (e) {
              ...
              return Math.abs(s - a) < 5 && t.x * e.x >= 0 && t.y * e.y >= 0
                ...
                : this._data.fillBack && s >= h && s <= a && t.x * e.x >= 0 && t.y * e.y >= 0
            ...
            (t.prototype._drawImpl = function (e) {
              if (null !== this._data) {
                ...
                e.scale(1, i),
                  this._data.fillBack &&
                    (this._data.point.x < this._data.center.x && ((o = -o), (l = -l)),
                    e.beginPath(),
                    e.moveTo(l, 0),
                    e.lineTo(o, 0),
        ...
        u = (function (e) {
          function t(t, i) {
            ...
            return (
              ...
              (r._polylineRenderer = new d.PolygonRenderer(new c.HitTestResult(c.HitTestResult.MOVEPOINT))),
          ...
          return (
            ...
            (t.prototype._updateImpl = function () {
              if ((e.prototype._updateImpl.call(this), this._points.length < 2)) this._renderer = null
              else {
                var t = this._source.properties().childs(),
                ...
                var _ = r(l, 'A')
                d.y > l.y ? ((_.vertAlign = 'bottom'), (_.offsetY = 5)) : ((_.vertAlign = 'top'), (_.offsetY = 5)),
                  this._textRendererALabel.setData(_),
                  i.append(this._textRendererALabel)
                var f = r(d, 'B')
                if (
                  (d.y < l.y ? ((f.vertAlign = 'bottom'), (f.offsetY = 5)) : ((f.vertAlign = 'top'), (f.offsetY = 5)),
                  this._textRendererBLabel.setData(f),
                  i.append(this._textRendererBLabel),
                  this._points.length > 2)
                ) {
                  var v = r(c, 'C')
                  c.y < d.y ? ((v.vertAlign = 'bottom'), (v.offsetY = 5)) : ((v.vertAlign = 'top'), (v.offsetY = 5)),
                ...
                if (this._points.length >= 3) {
                  this._abRetracementTrend.setData(o(l, c)), i.append(this._abRetracementTrend)
                  var y = l.add(c).scaled(0.5),
                    w = this._source.points(),
                    m = w[0],
                    x = w[1],
                    b = w[2],
                    R = Math.round(1e3 * Math.abs((b.price - x.price) / (x.price - m.price))) / 1e3,
                    T = r(y, this._numericFormatter.format(R))
                  this._abLabelRenderer.setData(T), i.append(this._abLabelRenderer)
                }
                if (this._points.length >= 4) {
                  this._cdRetracementTrend.setData(o(d, u)), i.append(this._cdRetracementTrend)
                  var S = d.add(u).scaled(0.5),
                    P = this._source.points(),
                    L = ((x = P[1]), (b = P[2]), P[3]),
                    C = Math.round(1e3 * Math.abs((L.price - b.price) / (b.price - x.price))) / 1e3,
                    M = r(S, this._numericFormatter.format(C))
                  this._cdLabelRenderer.setData(M), i.append(this._cdLabelRenderer)
                }
                this.addAnchors(i), (this._renderer = i)
              }
            }),
    ...
    bcXK: function (e, t, i) {
      ...
      function _(e, t) {
        u.call(this, e, t), (this._rendererCache = {}), (this._trendLineRenderer = new a()), (this._renderer = null)
      }
      inherit(p, c),
        (p.prototype._drawImpl = function (e) {
          ;(e.lineCap = 'butt'),
        ...
        (_.prototype._updateImpl = function () {
          if (
            ...
            if (!(this._floatPoints.length < 2)) {
              var m = new l(),
                x = ((e = this._floatPoints[0]), (a = this._source.properties()).fillBackground.value()),
              ...
              if (a.trendline.visible.value()) {
                ...
                this._trendLineRenderer.setData(L), m.append(this._trendLineRenderer)
              }
              this.addAnchors(m), (this._renderer = m)
            }
          }
          ...
          if (
            ...
            if (this._pattern && 2 === this._source.points().length) {
              ...
              if (f === u.Bars || f === u.OpenClose) {
                for (
                  var b = new d(), R = f === u.Bars ? ['high', 'low'] : ['open', 'close'], T = R[0], S = R[1], P = 0;
              ...
              this._medianRenderer.setData(z), b.append(this._medianRenderer), (this._renderer = b)
            }
          }
        }),
            ...
            for (
              ...
              if (f.visible.value()) {
                ...
                var b = {
                  ...
                  R = new a()
                R.setData(b), R.setHitTest(new s(s.MOVEPOINT, null, _)), t.append(R)
                var T = {
                    points: [m, x],
                    width: this._model.timeScale().width(),
                    height: this._source.priceScale().height(),
                  ...
                  S = new a()
                S.setData(T), S.setHitTest(new s(s.MOVEPOINT, null, _)), t.append(S)
              }
            }
            this.addAnchors(t), (this._renderer = t)
          }
            ...
            for (
              ...
              if (v.visible.value()) {
                ...
                var x = {
                  ...
                  b = new a()
                b.setData(x), b.setHitTest(new s(s.MOVEPOINT, null, f)), t.append(b)
                var R,
                  T = {
                    points: [w, m],
                    width: this._model.timeScale().width(),
                ...
                ;(R = new a()).setData(T), R.setHitTest(new s(s.MOVEPOINT, null, f)), t.append(R)
              }
            }
            this.addAnchors(t), (this._renderer = t)
          }
              ...
              for (var v = 0; v <= 8; v++) {
                ...
                if (g.visible.value()) {
                  ...
                  var b = {
                    ...
                    R = new a()
                  R.setData(b), R.setHitTest(new s(s.MOVEPOINT, null, v)), e.append(R)
                  var T,
                    S = {
                      points: [m, x],
                      width: this._model.timeScale().width(),
                  ...
                  ;(T = new a()).setData(S), T.setHitTest(new s(s.MOVEPOINT, null, v)), e.append(T)
                }
              }
              this.addAnchors(e), (this._renderer = e)
      ...
      inherit(d, n),
        ...
        (d.prototype._updateImpl = function () {
          if ((n.prototype._updateImpl.call(this), (this._renderer = null), 0 !== this._points.length)) {
            ...
            if (1 === this._points.length) {
              var u = new r(this._model.timeScale().width() / 2, this._points[0].y)
              ;(u.data = 0), (u.square = !0), e.append(this.createLineAnchor({ points: [u], pointsCursorType: h }))
            }
            this._renderer = e
          }
        }),
    ...
    dKqZ: function (e, t, i) {
      ...
      inherit(g, f),
        ...
        (g.prototype._drawImpl = function (e) {
          if (!(null === this._data || this._data.points.length < 2)) {
            ...
            ;(w = h(m, w)),
              ...
              (w = h(m, w)),
              (m = s(1, f / (2 * d))),
              (w = h(m, w)).y < 0 ? (this._data.clockwise = !0) : (this._data.clockwise = !1),
              e.save(),
              e.beginPath(),
              e.translate(t.x, t.y),
              e.rotate(y)
        ...
        (g.prototype.hitTest = function (e) {
          ...
          var m,
            x = 1 - Math.sqrt(3) / 2
          if (((w = s(1, (p * x) / d)), (e = h(w, e)), (f = h(w, f)), e.y * f.y < 0)) return null
          m = e.y < 0 ? new r(0.5 * p, (p * Math.sqrt(3)) / 2) : new r(0.5 * p, (-p * Math.sqrt(3)) / 2)
          ...
          if ((d.prototype._updateImpl.call(this), (this._renderer = null), 0 !== this._points.length)) {
            ...
            if (((u.data = 0), i.push(u), 1 !== e.points.length)) {
              ...
              if (((f.data = 1), 2 !== e.points.length)) {
                ...
                var L = e.points[2],
                  C = l(-m.x, -m.y)
                ;(L = h(C, L)), (C = o(-P)), (L = h(C, L)), (C = s(1, R / (2 * y)))
      ...
      function u(e, t, i) {
        for (var r = 0, a = i; r < a.length; r++)
          for (var o = a[r], s = 1; s < o.length; s++) {
            var l = o[s - 1],
              d = o[s]
            if (Object(n.distanceToSegment)(l, d, e).distance < t) return new h.HitTestResult(h.HitTestResult.MOVEPOINT)
          }
        return null
      }
      function p(e, t) {
        ...
        return (
          ...
          (t.prototype.hitTest = function (e, t) {
            if (null !== this._data && 3 === this._data.points.length) {
              ...
              return null === _ && (_ = u(e, i, this._data.extendRightSegments)), _
            }
            return null
          }),
          (t.prototype._drawImpl = function (e, t) {
            if (null !== this._data) {
              ...
              if (
                ...
                e.beginPath(), e.moveTo(r.x, r.y), e.lineTo(n.x, n.y), e.stroke()
              else {
                var o = n.subtract(r),
                ...
                this._data.fillBack &&
                  ...
                  e.stroke(),
                  this._data.leftEnd === s.LineEnd.Arrow && Object(c.drawArrow)(h, r, e, e.lineWidth, t.pixelRatio),
                  this._data.rightEnd === s.LineEnd.Arrow && Object(c.drawArrow)(d, n, e, e.lineWidth, t.pixelRatio)
              }
            }
          }),
          t
        ...
        (c.prototype._updateImpl = function () {
          if (
            ...
            if (((this._hfans = []), (this._vfans = []), C.fans.visible.value()))
              for (p = 1; p <= 7; p++) {
                ;(x = Math.round(w + C['hlevel' + p].coeff.value() * y)), (v = c + C['vlevel' + p].coeff.value() * h)
                this._hfans.push(this._model.timeScale().indexToCoordinate(x)),
                  this._vfans.push(this._source.priceScale().priceToCoordinate(v, u))
              }
            var R = new l()
            ...
            for (p = 0; p < this._hlevels.length; p++) {
              ...
              var B = {
                points: [(e = new r(T, this._hlevels[p].y)), (t = new r(P, this._hlevels[p].y))],
                width: this._model.timeScale().width(),
                height: this._source.priceScale().height(),
              ...
              if (((E = new s()).setData(B), R.append(E), C.showLeftLabels.value())) {
                var N = {
                  points: [e],
            ...
            for (p = 0; p < this._vlevels.length; p++) {
              ;(e = new r(this._vlevels[p].x, S)), (t = new r(this._vlevels[p].x, L))
              if (p > 0 && O) {
                k = this._vlevels[p - 1]
                var j,
                  z = new r(k.x, S)
              ...
              if (((E = new s()).setData(B), R.append(E), C.showTopLabels.value())) {
                var V = {
                  points: [e],
            ...
            var W = this
            Y(R, this._hfans, !0), Y(R, this._vfans, !1), this.addAnchors(R), (this._renderer = R)
          }
          function Y(e, t, i) {
            var n = new r(T, S),
              a = new r(P, S),
    ...
    hzaj: function (e, t, i) {
      ...
      var r = i('mrSG'),
        ...
        h = (function (e) {
          function t() {
            var t = (null !== e && e.apply(this, arguments)) || this
            return (t._polygonRenderer = new a.PolygonRenderer(null)), (t._renderer = new s.CompositeRenderer()), t
          }
          return (
            Object(r.c)(t, e),
            (t.prototype.renderer = function (e, t) {
          ...
          if (
            ...
            for (
              ...
              if (f.visible.value()) {
                ...
                ;(m = new a()).setData(w), m.setHitTest(new o(o.MOVEPOINT, null, p)), e.append(m)
                var m,
                  x = {
                ...
                ;(m = new a()).setData(x), m.setHitTest(new o(o.MOVEPOINT, null, p)), e.append(m)
              }
            }
            this.addAnchors(e), (this._renderer = e)
          }
        ...
        (u.prototype._updateImpl = function () {
          if (
            ...
            if (3 === this._points.length) {
              ;(e.data = 2), (i.data = 2), (t.data = 2), (l.data = 2), x.push(e, i, t, l)
              var R = o(_, f)
              b.push(R, R, R, R)
            }
            u.append(this.createLineAnchor({ points: x, pointsCursorType: b })), (this._renderer = u)
          }
        }),
        (u.prototype.renderer = function (e, t) {
          return this._invalidated && this._updateImpl(), this._renderer
          ...
          return (
            ...
            (t.prototype._updateBaseData = function () {
              ...
              if (this._source.points().length >= 4) {
                var n = this._source.points(),
                  a = ((t = n[0]), (i = n[1]), n[3])
                this._bcRetracement = Math.round(1e3 * Math.abs((a.price - t.price) / (i.price - t.price))) / 1e3
              }
              if (this._source.points().length >= 5) {
                var o = this._source.points(),
                  s = ((t = o[0]), (r = o[2]), (a = o[3]), o[4])
                ;(this._cdRetracement = Math.round(1e3 * Math.abs((s.price - a.price) / (a.price - r.price))) / 1e3),
                  (this._xdRetracement = Math.round(1e3 * Math.abs((s.price - a.price) / (t.price - a.price))) / 1e3)
              }
            }),
            t
          )
            ...
            (t.prototype._updateImpl = function () {
              ...
              if (i && !i.isEmpty()) {
                ...
                if (
                  ...
                  t.isPriceDencityLog() &&
                    !i.isLog() &&
                    (f = i.height() / (Object(c.toLog)(p.maxValue()) - Object(c.toLog)(p.minValue()))),
                    !t.isPriceDencityLog() &&
                      i.isLog() &&
                      (f = i.height() / (Object(c.fromLog)(p.maxValue()) - Object(c.fromLog)(p.minValue())))
    ...
    'obU/': function (e, t, i) {
      ...
      inherit(g, v),
        ...
        (g.prototype.hitTest = function (e) {
          ...
          ;(w = o(-y)), (e = h(w, e)), (m = h(w, m)), (w = s(1, f / (2 * d))), (e = h(w, e)), (m = h(w, m))
          var x = e.length()
          return this._additionalPointTest(e, m)
            ? Math.abs(x - 0.5 * f) <= 3
              ? new c(c.MOVEPOINT)
              : this._data.fillBackground && !this._data.noHitTestOnBackground && x <= 0.5 * f
        ...
        (y.prototype._updateImpl = function () {
          if ((d.prototype._updateImpl.call(this), (this._renderer = null), !(this._points.length < 2))) {
            ...
            t.append(this.createLineAnchor({ points: [v, g, y, w], pointsCursorType: x })), (this._renderer = t)
          }
        }),
        (t.EllipsePaneView = y)
    },
      ...
      inherit(T, a),
        ...
        (T.prototype._statLabelData = function () {
          ...
          if (u.showPriceRange.value() && this._source.priceScale()) {
            ...
            e =
              this._source.ownerSource().formatter().format(r) + ' (' + this._percentageFormatter.format(100 * _) + ')'
            var g = this._model.mainSeries().symbolInfo()
            g &&
              g !== this._lastSymbolInfo &&
              ((this._pipFormatter = new c(g.pricescale, g.minmov, g.type, g.minmove2)), (this._lastSymbolInfo = g)),
          ...
          if (T || x) {
            ...
            ;(a = this._source.pointToScreenPoint(h)[0].subtract(S)), (o = Math.round(1e5 * a.length()) / 1e5)
          }
          if (w || m || x) {
            if (((t = ''), w && ((n = h.index - l.index), (t += $.t('{0} bars').format(b(n)))), m)) {
            ...
            x &&
              (t && (t += ', '),
              (t += $.t('distance: {0} px').format(b(this._numericFormatter.format(Math.round(o)))))),
              t && p.push('barsRange')
          }
          T &&
            (o > 0 && ((a = a.normalized()), (y = Math.acos(a.x)), a.y > 0 && (y = -y)),
            'number' != typeof y ||
              TradingView.isNaN(y) ||
          ...
          if (
            ...
            if (!(this._points.length < 2)) {
              ...
              if (this._points.length >= 3) {
                ...
                var p = t.y - e.y
                if ((((o = e.clone()).y = n.y + p), (o.data = 3), d.fillBackground.value())) {
              ...
              this._trendLineRendererPoints43.setData(y(o, n)),
                ...
                m(this._p3LabelRenderer, this._p4LabelRenderer, n, o, this._price3, this._price4)
              var x = [e, t, n, o]
              this._model.lineBeingCreated() === this._source && x.pop(),
                l.append(this.createLineAnchor({ points: x, pointsCursorType: h })),
                (this._renderer = l)
            }
          }
        }),
        ...
        (h.prototype._updateImpl = function () {
          if ((n.prototype._updateImpl.call(this), (this._renderer = null), !(this._points.length < 2))) {
            var e = this._source.points(),
              ...
              f = this._model.timeScale()
            if (0 !== s) {
              for (var v = f.indexToCoordinate(a), g = [], y = a; v > -c; y -= s)
                (v = f.indexToCoordinate(y)), g.push(v)
              v = v = f.indexToCoordinate(a + s)
              for (y = a + s; v < f.width(); y += s) (v = f.indexToCoordinate(y)), g.push(v)
              for (var w = 0; w < g.length; w++) {
                var m = new l({
                  point: new r(g[w], h.y),
                  width: c,
    ...
    tjxb: function (e, t, i) {
      ...
      inherit(l, s),
        ...
        (l.prototype._drawImpl = function (e) {
          ...
          if (0 !== r) {
            var n = this._adapter.getArrowHeight(),
              ...
              l = 'buy' === this._adapter.getDirection() ? i + n + o : i - n - o - s
        ...
        (l.prototype.hitTest = function (e) {
          ...
          if (
            ...
            return new o(o.CUSTOM, {
              clickHandler: e,
              tapHandler: e,
              tooltip: '' !== s ? { text: s, rect: { x: r, y: t, w: 2, h: i - t } } : null,
            })
          }
          return null
        }),
        ...
        (h.prototype.renderer = function (e, t) {
          ...
          if (!isFinite(s.y) || s.y < 0 || s.y > e || s.x < 0) return (this._renderer = null), null
    ...
    'u+oH': function (e, t, i) {
      ...
      function w(e, t) {
        n.call(this, e, t),
          ...
          (this._fullStopBgRenderer = new s(new l(l.MOVEPOINT), new l(l.MOVEPOINT))),
          (this._stopBgRenderer = new s(new l(l.MOVEPOINT), new l(l.MOVEPOINT))),
          (this._fullTargetBgRenderer = new s(new l(l.MOVEPOINT), new l(l.MOVEPOINT))),
          (this._targetBgRenderer = new s(new l(l.MOVEPOINT), new l(l.MOVEPOINT))),
            ...
            if (i) {
              ...
              if (
                ...
                var l = new h(),
                  ...
                  m = this._points[f.ActualClose] ? this._points[f.ActualClose].x : this._points[f.Close].x,
                ...
                if (
                  ...
                  ;(b = new r(w, this._entryLevel)), (R = new r(m, this._closeLevel))
                  ;((C = {}).points = [b, R]),
                    (C.color = 'white'),
                    (C.linewidth = 0),
                    (C.backcolor = c.stopBackground.value()),
                ...
                ;(b = new r(g, this._entryLevel)), (R = new r(x, this._profitLevel))
                if (
                  (((C = {}).points = [b, R]),
                  (C.color = 'white'),
                  (C.linewidth = 0),
                ...
                ;(b = new r(g, this._points[f.Entry].y)), (R = new r(x, this._points[f.Entry].y))
                ...
                if (
                  (this._points[1] &&
                    void 0 !== this._pl &&
                    (V = this._source.ownerSource().formatter().format(this._pl)),
                  c.compact.value())
                )
                  (E += V ? V + ' ~ ' : ''), (E += c.qty.value() + '\n'), (E += H)
                else {
                ...
                this._pl < 0 ? (Y = c.stopBackground.value()) : this._pl > 0 && (Y = c.profitBackground.value()),
                  M(this._middleLabelRenderer, z, E, Y, 'middle', 0, 'white')
                ;(b = new r(g, this._stopLevel)), (R = new r(x, this._stopLevel))
                L(this._stopLineRenderer, b, R, c.stopBackground.value())
                var F = this._model.mainSeries().symbolInfo()
                F &&
                  F !== this._lastSymbolInfo &&
                  ((this._pipFormatter = new u(F.pricescale, F.minmov, F.type, F.minmove2)), (this._lastSymbolInfo = F))
                ...
                ;(E = c.compact.value()
                  ...
                  M(this._stopLabelRenderer, z, E, c.stopBackground.value(), I < O ? 'bottom' : 'top', 0)
                ;(b = new r(g, this._profitLevel)), (R = new r(x, this._profitLevel))
                ...
                ;(E = c.compact.value()
                  ...
                  M(this._profitLabelRenderer, z, E, c.profitBackground.value(), I < O ? 'top' : 'bottom', 0)
            ...
            (e.prototype.setData = function (e) {
              if (!(e.points.length < 4)) {
                ...
                if (
                  ...
                  null !==
                  Object(l.intersectLines)(Object(a.lineThroughPoints)(i, r), Object(a.lineThroughPoints)(n, o))
          ...
          return (
            ...
            (t.prototype.hitTest = function (e, t) {
              ...
              for (var i = 0, r = this._visiblePolygons(t); i < r.length; i++) {
                var n = r[i]
                if (Object(o.pointInPolygon)(e, n)) return new d.HitTestResult(d.HitTestResult.MOVEPOINT_BACKGROUND)
              }
              return null
            }),
            (t.prototype._drawImpl = function (e, t) {
              if (!(null === this._data || this._data.points.length < 4)) {
                e.fillStyle = Object(u.generateColor)(this._data.backcolor, this._data.transparency)
                for (var i = 0, r = this._visiblePolygons(t); i < r.length; i++) {
                  var n = r[i]
            ...
            (t.prototype._visiblePolygons = function (e) {
              ...
              var d = Object(l.intersectLines)(Object(a.lineThroughPoints)(r, o), Object(a.lineThroughPoints)(s, h))
              if (null === d) return []
              var c = [
                  new a.Point(0, 0),
                  new a.Point(e.cssWidth, 0),
              ...
              ;(p = v(p, d, _, [f, f])), null !== (p = v((p = y(p, t)), f, d, [_, _])) && u.push(p)
              p = c
              var g = o.subtract(r).add(d),
                w = s.subtract(h).add(d)
              return (p = v(p, d, g, [w, w])), null !== (p = v((p = y(p, t)), w, d, [g, g])) && u.push(p), u
            }),
            t
          )
          ...
          return (
            ...
            (t.prototype._updateImpl = function () {
              ...
              if (!(i.length < 2 || r.length < 2)) {
                ...
                if (o.length < 2) return this.addAnchors(l), void (this._renderer = l)
                var h = o[0],
                  ...
                  _ = d,
                  f = this._getModel(),
                  v = { barsCoordsRange: c, priceCoordsRange: u, startPoint: p, endPoint: _, p1: h, p2: d }
      ...
      inherit(u, n),
        (u.prototype._updateImpl = function () {
          if (
            ...
            var e = this._source.points()[0]
            2 === this._source.points().length && (y = this._source.points()[1])
            var t = this._source.properties(),
            ...
            if (null !== this._model.timeScale().visibleBarsStrictRange()) {
              ...
              for (var l = y ? y.index - e.index : 1, u = 1; u <= 11; u++) {
                ...
                if (p.visible.value()) {
                  ...
                  t.showLabels.value() && ((f.text = p.coeff.value()), (f.y = this._source.priceScale().height())),
                    this._levels.push(f)
                }
              }
              var v = new d()
              if ((t = this._source.properties()).fillBackground.value())
                for (u = 1; u < this._levels.length; u++) {
                  var g = this._levels[u - 1],
                    y = ((e = new r(this._levels[u].x, 0)), new r(g.x, this._source.priceScale().height())),
                    w = {}
                  ;(w.points = [e, y]),
              ...
              for (u = 0; u < this._levels.length; u++) {
                ...
                if (((x = new a()).setData(m), x.setHitTest(b), v.append(x), void 0 !== this._levels[u].text)) {
                  var R,
                    T = t.horzLabelsAlign.value()
                  switch (
                    ((T = 'left' === T ? 'right' : 'right' === T ? 'left' : 'center'), t.vertLabelsAlign.value())
                  ) {
                    case 'top':
      ...
      var c = (function (e) {
        ...
        return (
          ...
          (t.prototype._addAnchors = function (e) {
            ...
            e.append(this.createLineAnchor({ points: [i, r, o, s], pointsCursorType: l }))
          }),
          ...
          if (
            ...
            if (!(this._floatPoints.length < 2)) {
              ...
              for (e = this._floatPoints[0], t = this._floatPoints[1], f = 0; f < this._hlevels.length; f++) {
                ...
                ;(F = new s()).setData(k),
                  F.setHitTest(new l(l.MOVEPOINT, null, { type: 'h', index: this._hlevels[f].index })),
                  S.append(F)
              }
              for (f = 0; f < this._vlevels.length; f++) {
                ...
                ;(F = new s()).setData(k),
                  F.setHitTest(new l(l.MOVEPOINT, null, { type: 'v', index: this._vlevels[f].index })),
                  S.append(F)
              }
