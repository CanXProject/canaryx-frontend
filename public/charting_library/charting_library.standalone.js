var TradingView = (function (t) {
  ...
  function r() {
    return 'CL v19.038 (internal id 605618ef @ 2021-08-09T15:11:06.753Z)'
  }
  var s = (function () {
    function t(t) {
      if (
      ...
      'Dark' === this._options.theme &&
        ...
        (this._options.loading_screen = { backgroundColor: '#92959A' }),
        this._create()
    }
    return (
      ...
      (t.prototype._render = function () {
        ...
        var e =
          ...
          (encodeURIComponent(this._options.locale) + '-tv-chart.605618ef.html#symbol=') +
