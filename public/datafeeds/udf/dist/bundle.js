!(function (e, t) {
  'object' == typeof exports && 'undefined' != typeof module
    ...
    ? define(['exports'], t)
    : t(((e = 'undefined' != typeof globalThis ? globalThis : e || self).Datafeeds = {}))
})(this, function (e) {
  'use strict'
  var r = function (e, t) {
    return (r =
              ...
              if ('ok' === e.s || 'no_data' === e.s) {
                ...
                if ('no_data' === e.s) (r.noData = !0), (r.nextTime = e.nextTime)
                  ...
                  for (var s = void 0 !== e.v, o = void 0 !== e.o, n = 0; n < e.t.length; ++n) {
                    ...
                    o && ((i.open = parseFloat(e.o[n])), (i.high = parseFloat(e.h[n])), (i.low = parseFloat(e.l[n]))),
  ...
  var a =
    ((s.prototype.subscribeBars = function (e, t, r, s) {
      this._subscribers.hasOwnProperty(s) ||
        ((this._subscribers[s] = { lastBarTime: null, listener: r, resolution: t, symbolInfo: e }), e.name)
    }),
    ...
    (s.prototype._updateDataForSubscriber = function (t) {
      ...
      return this._historyProvider
        .getBars(e.symbolInfo, e.resolution, { from: o, to: s, countBack: 2, firstDataRequest: !1 })
        .then(function (e) {
      ...
      try {
        for (var e = r.symbol.length, o = void 0 !== r.ticker; s < e; ++s) {
          ...
          ;(this._symbolsInfo[h] = l),
            ...
            void 0 !== c &&
              ((this._symbolsInfo[f(h, c)] = l), (this._symbolsInfo[f(n, c)] = l), (this._symbolsInfo[f(u, c)] = l)),
  ...
  var d =
    ...
    (m.prototype._setupWithConfiguration = function (e) {
      ...
      ;(!e.supports_group_request && e.supports_search) ||
        (this._symbolsStorage = new c(this._datafeedURL, e.supported_resolutions || [], this._requester)),
        JSON.stringify(e)
    }),
    m)
  function m(e, t, r, s) {
  ...
  var q,
    ...
    k =
      (r((w = I), (S = q = d)),
      (w.prototype = null === S ? Object.create(S) : ((x.prototype = S.prototype), new x())),
      I)
  function x() {
    this.constructor = w
  }
