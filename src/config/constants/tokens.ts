...
export const mainnetTokens = {
  ...
  // bnb here points to the wbnb contract. Wherever the currency BNB is required, conditional checks for the symbol 'SGB' can be used
  bnb: new Token(MAINNET, '0x02f0826ef6aD107Cfc861152B32B52fD11BaB9ED', 18, 'SGB', 'SGB', 'https://www.binance.com/'),
  cake: new Token(
    MAINNET,
  ...
  ifotoken: new Token(
    MAINNET,
    '0x0a4d7D0FcB750C5B9B99c61d720a3124486271da',
    18,
    'Sample',
    'Sample Token',
    'https://canarydex.netlify.app/',
