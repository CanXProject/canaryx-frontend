...
import tokenGenAbi from 'config/abi/adminToken.json'
...
export const getTokenGenContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(tokenGenAbi, getTokenGenAddress(), signer)
}
