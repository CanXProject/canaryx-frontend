...
import { Box, Flex, lightColors, Spinner, Text, Timeline } from 'canaryx-uikit'
...
const PancakeSquadHeader: React.FC<PancakeSquadHeaderType> = ({
  ...
  return (
    ...
    >
      ...
      <Text color={lightColors.warning} textAlign="center" bold>
        {t('Mint Cost: %minCost% CANARY each', {
          minCost: DEFAULT_CANARY_COST,
        })}
      </Text>
      <Text color={lightColors.warning} textAlign="center" bold>
      ...
      <Text color={lightColors.invertedContrast} textAlign="center">
        {t('Canary Exchange’s first official generative NFT collection.')}
      </Text>
