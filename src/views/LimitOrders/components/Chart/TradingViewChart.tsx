...
const TradingViewChart = ({
  ...
  useEffect(()=>{
    const chart = createChart("canarychart2",{
      layout: {
  ...
  document.getElementById("switcher2").appendChild(switcherElement);
  ...
  return (
    ...
    <div id="switcher2" />
      ...
      >
        ...
        <Flex id="canarychart2" flexDirection="column" p="-12px" position="relative" height="100%" width="100%"/>
      </Flex>
    </>
  )
}
