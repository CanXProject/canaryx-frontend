...
import { ADMINS, PANCANARY_SPACE, SNAPSHOT_VERSION } from './config'
...
export const generateMetaData = () => {
  return {
    plugins: {},
    network: 19,
    strategies: [{ name: 'cake', params: { symbol: 'CANARY', address: tokens.cake.address, decimals: 18 } }],
  }
}
