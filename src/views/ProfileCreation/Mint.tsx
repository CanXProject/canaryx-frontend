...
import { Card, CardBody, Heading, Text } from 'canaryx-uikit'
      ...
      <Card mb="24px">
        <CardBody>
          ...
          <Text as="p" mb="24px" color="textSubtle">
            {t('Cost: %num% CANARY', { num: formatUnits(MINT_COST) })}
          </Text>
          {starterNfts.map((nft) => {
          ...
          {!hasMinimumCakeRequired && (
            <Text color="failure" mb="16px">
              {t('A minimum of %num% CANARY is required', { num: formatUnits(MINT_COST) })}
            </Text>
          )}
