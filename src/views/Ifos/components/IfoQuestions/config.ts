  ...
  return [
    {
      ...
      description: [
        t(
          'In the Basic Sale, every user can commit a maximum of about 100 USD worth of CANARY. We calculate the maximum CANARY amount about 30 minutes before each IFO. The Basic Sale has no participation fee.',
        ),
        t(
          'In the Unlimited Sale, there’s no limit to the amount of CANARY you can commit. However, there’s a fee for participation: see below.',
        ),
      ],
    },
    {
