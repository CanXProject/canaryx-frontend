...
import { Flex, Text, Button, ArrowUpIcon, LinkExternal } from 'canaryx-uikit'
  ...
  return (
    <>
      <Flex p="16px" flexDirection="column" alignItems="center" justifyContent="space-between" height="150px">
        ...
        <LinkExternal href={getBscScanLink(txHash, 'transaction', chainId)}>{t('View on Explorer')}</LinkExternal>
      </Flex>
      <Divider />
