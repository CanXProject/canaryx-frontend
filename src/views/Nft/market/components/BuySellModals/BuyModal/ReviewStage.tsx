...
import { Flex, Text, Button, ButtonMenu, ButtonMenuItem, Message, Link } from 'canaryx-uikit'
    ...
    <>
      <Flex px="24px" pt="24px" flexDirection="column">
        ...
        <BorderedBox>
          ...
          <Text small color="textSubtle">
            {t('%symbol% in wallet', { symbol: paymentCurrency === PaymentCurrency.BNB ? 'SGB' : 'WSGB' })}
          </Text>
          {!account ? (
          ...
          <Message p="8px" variant="danger">
            <Text>
              {t('Not enough %symbol% to purchase this NFT', {
                symbol: paymentCurrency === PaymentCurrency.BNB ? 'SGB' : 'WSGB',
              })}
            </Text>
          </Message>
        )}
        <Flex alignItems="center">
          ...
          <Button
            ...
            external
            variant="text"
            href="/swap?inputCurrency=BNB&outputCurrency=0x02f0826ef6aD107Cfc861152B32B52fD11BaB9ED"
          >
            {t('Convert')}
          </Button>
        </Flex>
      ...
      <Flex px="24px" pb="24px" flexDirection="column">
        ...
        <Button as={Link} external style={{ width: '100%' }} href="/swap?outputCurrency=BNB" variant="secondary">
          {t('Get %symbol1% or %symbol2%', { symbol1: 'SGB', symbol2: 'WSGB' })}
        </Button>
      </Flex>
    </>
  )
