...
import { Text, Flex, Button, ArrowForwardIcon, Heading } from 'canaryx-uikit'
...
const StyledHeading = styled(Heading)`
  color: #ffffff;
  background: -webkit-linear-gradient(#0088ca 0%, #452a7a 100%);
  background-clip: text;
  -webkit-background-clip: text;
...
const Wrapper = styled.div`
  border-radius: 32px;
  width: 100%;
  background-image: linear-gradient(#0088ca, #452a7a);
