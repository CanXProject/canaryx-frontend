...
import { Flex, Text, TicketFillIcon, PredictionsIcon } from 'canaryx-uikit'
...
const LotteryCardData: IconCardData = {
  ...
  background: ' linear-gradient(180deg, #0088ca 0%, #5121B1 100%);',
  borderColor: '#3C1786',
  rotation: '1.43deg',
}
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'CANARY card' },
    { src: 'green', alt: 'Green CANARY card with up arrow' },
    { src: 'red', alt: 'Red Cake card with down arrow' },
    { src: 'top-right', alt: 'CANARY card' },
  ],
}
      ...
      <TransparentFrame isDark={theme.isDark}>
        <Flex flexDirection="column" alignItems="center" justifyContent="center">
          ...
          <Text mb="40px" color="textSubtle">
            {t('Win big with Canary Exchange.')}
          </Text>
