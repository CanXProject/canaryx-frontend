...
import { Flex, Text, Skeleton, Button, ArrowForwardIcon } from 'canaryx-uikit'
...
const LotteryCardContent = () => {
  ...
  const cakePrizesText = t('%cakePrizeInUsd% in CANARY prizes this round', { cakePrizeInUsd: cakePriceBusdAsString })
    ...
    <>
      <Flex flexDirection="column" mt="48px">
        ...
        <Text color="white" mb="40px">
          {t('Buy tickets with CANARY, win CANARY if your numbers match')}
        </Text>
      </Flex>
