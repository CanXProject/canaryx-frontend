...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and CANARY pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and CANARY pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from CANARY pool', data)
  }
