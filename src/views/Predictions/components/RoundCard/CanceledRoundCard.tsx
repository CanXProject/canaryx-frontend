...
import { Card, CardBody, Text, Flex, BlockIcon, LinkExternal } from 'canaryx-uikit'
      ...
      <CardBody p="16px">
        ...
        <RoundResultBox>
          <Flex flexDirection="column" alignItems="center">
            ...
            <LinkExternal href="https://Canary Exchange.gitbook.io/Canary Exchange/products/prediction" external>
              {t('Learn More')}
            </LinkExternal>
          </Flex>
        </RoundResultBox>
